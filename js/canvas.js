...
// clear button
  ...
  tsBtn.src = "assets/img/clock.svg";
  tsBtn.width = "50";
  tsBtn.height = "50";

  const bgBtn = document.createElement('img')
  bgBtn.classList.add('btn')
  bgBtn.src = "assets/img/background.svg";
  bgBtn.width = "50";
  bgBtn.height = "50";
...
// тут необхідно додати код очистки canvas та масиву точок (clearRect)
  ...
  bgBtn.addEventListener('click', () => {
    const img = new Image;
    img.src =`https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/FullMoon2010.jpg/290px-FullMoon2010.jpg`;
    img.onload = () => {
